...
class write_csv2:
    ...
    def __init__(self, In):
        ...
        self.dataframe.to_csv("/Users/guokai/Desktop/git/Rutgers_Railway_security_research/Cyber_Risk_Research/train_schedule2.csv", index=0, sep=',', mode='w', header=1, columns=columns)
        n = 2
        while n < len(self.In):
            ...
            self.dataframe.to_csv("/Users/guokai/Desktop/git/Rutgers_Railway_security_research/Cyber_Risk_Research/train_schedule2.csv", index=0, sep=',', mode='a', header=0, columns=columns)
            n += 1
