...
class train_delay(generate_train):
    'delay'
    ...
    def print_diff(self):
        ...
        while n <= num_delay:
            ...
            print 'Train' + str(delay_schedule[n][0]) + ' ' + str(delay_schedule[n][1]) + ' ' + delay_schedule[n][2] + ' ' + str(delay_schedule[n][3]) + 'Tons' + ' Delay:' + str(delay_schedule[n][5]) + 'mins' + '\n'
            n += 1